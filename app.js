...
const filmsData = [
  ...
  },
  {
    ...
    poster: "https://m.media-amazon.com/images/M/MV5BMjM1NjE5NjQxN15BMl5BanBnXkFtZTgwMjYzMzQxMDE@._V1_FMjpg_UX1000_.jpg",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    instruktør: 'Steven Spielberg',
    gengre: 'action/adventure',
    poster: "https://cdn.shopify.com/s/files/1/1057/4964/products/Indiana-Jones-and-the-Temple-of-Doom-Vintage-Movie-Poster-Original-1-Sheet-27x41-3642.jpg?v=1673931663",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    instruktør: 'Steven Spielberg',
    gengre: 'Drama',
    poster: "https://m.media-amazon.com/images/I/41iN-iumaAL._AC_UF894,1000_QL80_.jpg",
  },
  {
    id: 8,
    ...
    instruktør: 'Steven Spielberg',
    gengre: 'action/adventure',
    poster: "https://static.posters.cz/image/750/plakater/indiana-jones-the-last-crusade-one-sheet-2-i3283.jpg",
  },
  {
    id: 9,
    titel: 'Jurassic Park',
    ...
    instruktør: 'Steven Spielberg',
    gengre: 'action/adventure',
    poster: "https://static.posters.cz/image/1300/plakater/jurassic-park-i75969.jpg",
  },
  {
    id: 10,
...

  {
    ...
    gengre: ['krimi', 'Drama'],
    poster: "https://m.media-amazon.com/images/I/51h0naTfOUL._AC_UF894,1000_QL80_.jpg",
  },
...

  {
    ...
    instruktør: 'Martin Scorsese',
    gengre: ['sport', 'Drama'],
    poster: "https://images.photowall.com/products/71046/raging-bull-3.jpg?h=699&q=85",
  },

  {
    ...
    instruktør: 'Martin Scorsese',
    gengre: ['krimi', 'Drama'],
    poster: "https://musicart.xboxlive.com/7/5c311200-0000-0000-0000-000000000002/504/image.jpg?w=1920&h=1080",
  },
...

  {
    ...
    instruktør: 'Martin Scorsese',
    gengre: 'Drama',
    poster: "https://images.photowall.com/products/72068/cape-fear.jpg?h=699&q=85",
  },

  {
    ...
    poster: "https://m.media-amazon.com/images/M/MV5BNDg3MmI1ZDYtMDZjYi00ZWRlLTk4NzEtZjY4Y2U0NjE5YmRiXkEyXkFqcGdeQXVyNzAxMjE1NDg@._V1_.jpg",
  },

  {
    ...
    instruktør: 'Martin Scorsese',
    gengre: 'Drama',
    poster: "https://m.media-amazon.com/images/M/MV5BZTYzMjA2M2EtYmY1OC00ZWMxLThlY2YtZGI3MTQzOWM4YjE3XkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_FMjpg_UX1000_.jpg",
  },
...

  {
    ...
    poster: "https://m.media-amazon.com/images/I/51nw5JAEYFL._AC_UF894,1000_QL80_.jpg",
  },
  ...
  ////////////////////////
   /////Country/////
   {
    ...
    gengre: 'Drama',
    poster: "https://content.gucca.dk/covers/big/b/a/babettes-gaestebud_563.jpg",
  },
...

  {
    ...
    gengre: 'Drama',
    poster: "https://content.gucca.dk/covers/big/d/a/dansen-med-regitze_3217.jpg",
  },

  {
    ...
    gengre: 'Drama',
    poster: "https://assets-p-dfi.pqcloud.eu/preview/AFGf4dAv47qANZv7fFdZkz/previews/maxWidth_1200_maxHeight_1200.jpg/*/AFGf4dAv47qANZv7fFdZkz_mini.jpg?authcred=R3Vlc3Q6R3Vlc3Q=",
  },
...

  {
    ...
    gengre: 'Drama',
    poster: "https://www.uv.es/recursos/fatwirepub/ccurl/367/701/un_assumpte_reial-2012,4.jpg",
  },

  {
    ...
    gengre: 'Drama',
    poster: "https://www.norden.org/sites/default/files/styles/content_size_800/public/images/Jagten%2520%2528Danmark%2529635025.jpeg?itok=_gYaxohF",
  },

  {
    ...
    gengre: 'Drama',
    poster: "https://www.kino.dk/sites/default/files/movie-posters/krigenteaserplakat.jpg",
  },

  {
    ...
    gengre: 'Drama',
    poster: "https://www.kino.dk/sites/default/files/movie-posters/undersandetposter1.jpg",
  },

  {
    ...
    gengre: 'Drama',
    poster: "https://resources.mynewsdesk.com/image/upload/c_fill,dpr_auto,f_auto,g_auto,q_auto:good,w_746/mj9vamsnkwhcqoluqkbo",
  },
...
const checkAchSpielberg = function () {
  //count if filmSetData contains "Steven Spielberg"
  const spielbergFilms = filmSetData.filter(film => film.instruktør === 'Steven Spielberg');
...
const checkAchScorsese = function () {
  //count if filmSetData contains "Martin Scorsese"
  const scorseseFilms = filmSetData.filter(film => film.instruktør === 'Martin Scorsese');
...
/////////////////////////////////////////
// open/close function on achivement popup
...
document.addEventListener('keydown', function (e) {
  if (e.key === 'Escape' && !achPopup.classList.contains('hidden')) { closePopup() }
})
...
const popupContent = function (a, b) {
  const achName = document.querySelector('.achpopup-box-explain').textContent = `${a}`;
  const acReward = document.querySelector('.achpopup-box-point').textContent = `${b} point! `;
}
...
const clickTricker = function (i, id) {
  btnWatched[i].addEventListener('click', function () {
    ...
    if (!filmSetData.some(film => film.id === id)) {
      // If green-border class is not present, add corresponding object to filmSetData array
      filmSetData.push(filmToAddOrRemove);
      filmSet = filmSetData.length;
      console.log(filmSetData); // Print filmSetData array to console for debugging purposes
      checkAch();
      //testAch(filmToAddOrRemove.director, 5);

    } else {
      // If green-border class is present, remove corresponding object from filmSetData array
    ...
    // update the values in the HTML document
    document.querySelector(".point").textContent = achievementPoints;
    document.querySelector(".film-set").textContent = filmSet;
